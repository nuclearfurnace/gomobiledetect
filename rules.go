...
func DefaultRules() *Rules {
	...
	rules.regenerateMobileDetectionRules()
	return rules
}
...
func (r *Rules) regenerateMobileDetectionRules() {
	// Build a combined list of all rules.
	...
	// Generate compiled regular expressions for all of our rules.
	regexes := make(map[string]*regexp.Regexp)
	for _, rule := range r.combined {
		rule = `(?is)` + rule
